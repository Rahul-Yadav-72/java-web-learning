...
<div class="row">
    ...
    <div class="col-md-2 sidebar">
        ...
        <a href="${pageContext.request.contextPath}/teacher/assignments" class="active">📝 Assignments</a>
    ...
    <div class="col-md-10 p-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/teacher/save-assignment"
                      method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control form-control-sm"
                                       style="width:80px;" placeholder="Marks">
                            </td>
                            <td>
                                <a href="#" class="btn btn-sm btn-primary">Download</a>
                                <button class="btn btn-sm btn-success">Save Marks</button>
                            </td>
                        </tr>
                    </tbody>

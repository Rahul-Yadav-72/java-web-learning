...
<div class="container mt-5">
    ...
    <div class="about-header">
        ...
        <p>Your online learning platform for coding, web development, and more.</p>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-6">
            <h3>Our Mission</h3>
            <p>
                EduPortal aims to provide high-quality online courses that help learners
                develop new skills, enhance their knowledge, and advance their careers.
                We focus on practical learning with interactive content and real-world projects.
            </p>
        </div>
        <div class="col-md-6">
            <h3>Our Vision</h3>
            <p>
                To be a leading e-learning platform that empowers students globally
                to learn at their own pace and succeed in the digital world.
            </p>
        </div>
    </div>
    ...
    <div class="text-center mt-5 mb-5">
        ...
        <a href="${pageContext.request.contextPath}/course" class="btn btn-primary btn-custom mt-3">View Courses</a>
    </div>

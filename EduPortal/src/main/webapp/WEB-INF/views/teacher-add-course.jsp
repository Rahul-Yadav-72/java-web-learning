...
<nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <span class="text-white">Welcome, ${teacherName}</span>
    </div>
</nav>
...
<div class="row">
    ...
    <div class="col-md-2 sidebar">
        ...
        <a href="${pageContext.request.contextPath}/teacher/add-course" class="active">➕ Add Course</a>
            ...
            <div class="col-md-8">
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/teacher/save-course"
                              method="post">

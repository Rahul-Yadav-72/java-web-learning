...
<div class="row">
    ...
    <div class="col-md-2 sidebar">
        ...
        <a href="${pageContext.request.contextPath}/teacher/quizzes" class="active">🧠 Quizzes</a>
    ...
    <div class="col-md-10 p-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/teacher/save-quiz" method="post">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>30 mins</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/teacher/quiz/1"
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-secondary text-white">
                ➕ Add Question (For Selected Quiz)
            </div>

            <div class="card-body">

                <form action="${pageContext.request.contextPath}/teacher/save-question"
                      method="post">
